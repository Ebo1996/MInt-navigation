  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 10% 50%, rgba(200,150,30,0.04) 0%, transparent 60%), radial-gradient(ellipse at 90% 20%, rgba(28,63,101,0.20) 0%, transparent 55%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 pt-14 pb-10 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 mb-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p
              ...
              style={{ color: "rgba(255,255,255,0.40)", maxWidth: 320 }}
            >
              {t("footer_about")}
            </p>
          ...
          <div className="lg:col-span-2">
            <h4
              className="text-xs font-black uppercase mb-5 tracking-widest"
              style={{ color: T.goldLight, letterSpacing: "0.16em" }}
            >
              {t("quick_nav")}
            </h4>
            ...
            >
              {[
                ...
                },
                {
                  ...
                  text: "+251 11 126 5737",
                  href: "tel:+251111265737",
                },
                {
                  icon: <FiMail size={13} />,
                  text: "contact@mint.gov.et",
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          {/* Secure badge */}
          <div
            className="flex items-center gap-2 px-4 py-2 rounded-xl order-1 md:order-2"
            style={{
              background: "rgba(255,255,255,0.03)",
          ...
          <div className="flex items-center gap-1.5 order-3">
            {["#078930", "#FCDD09", "#EF2118"].map((c, i) => (
              <div
                ...
                style={{ width: 18, height: 6, background: c, opacity: 0.7 }}
              />
            ))}
            <span
