  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <KpiCard label="Total Desks"       value={stats.totalDepts}            icon={<FiGrid size={18} />}          color="emerald" />
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                {stats.buildingA.depts} desks · {stats.buildingA.floors} floors
              </p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border p-5 border-l-4 border-l-blue-500">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-gray-500 text-sm">
                {stats.buildingB.depts} desks · {stats.buildingB.floors} floors
              </p>
            </div>
            <div className="text-right">
        ...
        <div className="bg-white rounded-xl shadow-sm border p-5">
          <div className="flex justify-between items-center mb-5">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-800">Desk Ratings</h2>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <QuickActionCard icon={<FiGrid />}      title="Add Desk"       description="Create new desk"        color="emerald" link="/admin/departments"    />
          <QuickActionCard icon={<FiInbox />}     title="System Inbox"   description="View user feedback"    color="red"     link="/admin/system-inbox"   />
          <QuickActionCard icon={<FiUsers />}     title="Dept Heads"      description="Manage dept access"    color="blue"    link="/admin/sector-managers" />
