...
// Sector Manager middleware (legacy - kept for backward compat)
const sectorManagerOnly = (req, res, next) => {
  if (
    req.admin &&
    (req.admin.role === "sector_manager" ||
      req.admin.role === "department_head" ||
...
const departmentHeadOnly = (req, res, next) => {
  if (
    req.admin &&
    (req.admin.role === "department_head" ||
      req.admin.role === "sector_manager" ||
