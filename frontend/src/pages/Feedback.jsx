...
const T = {
  ...
  card:"#FFFFFF", border:"#D8E2EF", text:"#086976",
...
const Feedback = () => {
  ...
  const deskName = typeof department?.name === "object"
    ? (department.name.en || department.name.am || "Desk")
    : (department?.name || "Desk");
          ...
          <motion.div className="rounded-2xl p-5 mb-6"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-base font-bold" style={{ color:T.text }}>{deskName}</h1>
